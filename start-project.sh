...
DB_CONTAINER_NAME="kaksedthan_postgres_db"
APP_CONTAINER_NAME="kaksedthan_app_backend"
...
echo -e "   • ${BOLD}PostgreSQL Database Host:${RESET} ${CYAN}localhost:${DB_HOST_PORT}${RESET} (Database: ${CYAN}kaksedthan_herdbook${RESET})"
echo ""

...
async function safeMigrate() {
  ...
  try {
    ...
    await client.query(`
      ...
      ALTER TABLE sires ADD COLUMN IF NOT EXISTS dob TIMESTAMP WITH TIME ZONE;
      ALTER TABLE sires ADD COLUMN IF NOT EXISTS breed_id VARCHAR(50);
      ALTER TABLE sires ADD COLUMN IF NOT EXISTS bloodline VARCHAR(100);
      ALTER TABLE sires ADD COLUMN IF NOT EXISTS sourcing_company VARCHAR(100);
      ALTER TABLE sires ADD COLUMN IF NOT EXISTS sourcing_company_id VARCHAR(50);
      ...
      ALTER TABLE sires ADD COLUMN IF NOT EXISTS owner_name VARCHAR(255);
      ALTER TABLE sires ADD COLUMN IF NOT EXISTS farm_id VARCHAR(50);
      ALTER TABLE sires ADD COLUMN IF NOT EXISTS farm_location VARCHAR(255);
      ...
      ALTER TABLE sires ADD COLUMN IF NOT EXISTS ownership_status VARCHAR(50) DEFAULT 'Active';
      ALTER TABLE sires ADD COLUMN IF NOT EXISTS ownership_start_date TIMESTAMP WITH TIME ZONE;
      ALTER TABLE sires ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP;

      ALTER TABLE dams ADD COLUMN IF NOT EXISTS dob TIMESTAMP WITH TIME ZONE;
      ...
      ALTER TABLE dams ADD COLUMN IF NOT EXISTS owner_name VARCHAR(255);
      ALTER TABLE dams ADD COLUMN IF NOT EXISTS farm_id VARCHAR(50);
      ALTER TABLE dams ADD COLUMN IF NOT EXISTS farm_location VARCHAR(255);
      ALTER TABLE dams ADD COLUMN IF NOT EXISTS availability VARCHAR(50) DEFAULT 'Available';
      ALTER TABLE dams ADD COLUMN IF NOT EXISTS breeding_status VARCHAR(50) DEFAULT 'Open';
      ALTER TABLE dams ADD COLUMN IF NOT EXISTS pregnancy_status VARCHAR(50) DEFAULT 'Open';
      ...
      ALTER TABLE dams ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP;

      ALTER TABLE calves ADD COLUMN IF NOT EXISTS dob TIMESTAMP WITH TIME ZONE;
      ALTER TABLE calves ADD COLUMN IF NOT EXISTS breed_id VARCHAR(50);
      ALTER TABLE calves ADD COLUMN IF NOT EXISTS father_id VARCHAR(50);
      ALTER TABLE calves ADD COLUMN IF NOT EXISTS mother_id VARCHAR(50);
      ALTER TABLE calves ADD COLUMN IF NOT EXISTS owner_type VARCHAR(50);
      ALTER TABLE calves ADD COLUMN IF NOT EXISTS owner_id VARCHAR(50);
      ALTER TABLE calves ADD COLUMN IF NOT EXISTS owner_name VARCHAR(255);
      ALTER TABLE calves ADD COLUMN IF NOT EXISTS farm_id VARCHAR(50);
      ALTER TABLE calves ADD COLUMN IF NOT EXISTS farm_location VARCHAR(255);
      ...
      ALTER TABLE calves ADD COLUMN IF NOT EXISTS image_url TEXT;
      ALTER TABLE calves ADD COLUMN IF NOT EXISTS status VARCHAR(50) DEFAULT 'Active';
      ALTER TABLE calves ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP;
      ...
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS user_id VARCHAR(50);
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS farm_location VARCHAR(100);
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS farm_id VARCHAR(50);
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS address TEXT;
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS province VARCHAR(100);
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS district VARCHAR(100);
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS commune VARCHAR(100);
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS village VARCHAR(100);
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS image_url TEXT;
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS national_id VARCHAR(100);
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS id_front_url TEXT;
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS id_back_url TEXT;
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS id_verification_status VARCHAR(50) DEFAULT 'Verified';
      ALTER TABLE breeders ADD COLUMN IF NOT EXISTS notes TEXT;
